...
```{r plant_data}
# plant level
plants_I_V <- read_csv("./Evolution experiment/Data/plants_I-V.csv", 
    col_types = cols(
...
save_plot("./Evolution experiment/Figures/FigureS6.pdf", fig, dpi = 1000,
          base_width = 6,
          base_height = 10)
```
...
qPCR_all <- read_csv("./Evolution experiment/Data/qPCR_compiled.csv", 
...
nod_plates <- read_csv("./Evolution experiment/Data/nod_plates.csv", 
